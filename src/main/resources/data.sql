...
INSERT INTO publication (topic, publication_type) VALUES ('Jin-Gu kang, Yong-Sik Choi, Jin-Woo Jung, “A Method of Enhancing Rapidly-Exploring Random Tree Robot Path Planning Using Midpoint Interpolation,” Sensors, Vol. 11, No. 18, 2021 (SCIE)', 'JOURNAL');
INSERT INTO publication (topic, publication_type) VALUES ('Jin-Gu kang, Dong-Woo Lim, Yong-Sik Choi, Woo-Jin Jang, Jin-Woo Jung, “Improved RRT-Connect Algorithm Based on Triangular Inequality for Robot Path Planning,” Sensors, Vol. 21, No. 2, 2021 (SCIE)', 'JOURNAL');
